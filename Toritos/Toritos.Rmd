...
stargazer(best.glm, best.glm2, best.glm3, title="Results", align=TRUE, type="ascii", out="Table2.txt")
...
ggplot(pred, aes(Carga, abundancia))+geom_ribbon(aes(ymin=SeBellow, ymax=SeAbove), colour="lightgrey") + geom_line(color="black")+theme_bw()
...
ggplot(pred2, aes(Pendiente, abundancia))+geom_ribbon(aes(ymin=SeBellow, ymax=SeAbove), colour="lightgrey") + geom_line(color="black")+theme_bw()
```